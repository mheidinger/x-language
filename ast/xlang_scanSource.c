...
int xlang_scan_BeginSourceFile
# ifdef HAVE_ARGS
   (char * FileName)
# else
...
int xlang_scan_BeginSourceFileW
# ifdef HAVE_ARGS
   (wchar_t * FileName)
# else
...
void xlang_scan_BeginSourceMemory
# ifdef HAVE_ARGS
   (void * InputPtr)
# else
...
# endif
   ...
   xlang_scan_BeginSourceMemoryN (InputPtr, length);
}

void xlang_scan_BeginSourceMemoryN
# ifdef HAVE_ARGS
...
void xlang_scan_BeginSourceGeneric
# ifdef HAVE_ARGS
   (void * InputPtr)
# else
   (InputPtr) void * InputPtr;
